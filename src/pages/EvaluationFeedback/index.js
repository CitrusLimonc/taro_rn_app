            ...
            <View>
				<ScrollView style={{
					...
					<View style={{
						...
						borderBottomWidth: px(2)}}><Text style={{fontSize:26}}>感谢您花时间参与我们的调研，请给下列内容打分</Text></View>
					<View style={{paddingTop: px(24)}}><Text style={{fontSize:px(36)}}>铺货速度</Text></View>
					...
					<View style={{paddingTop: px(24),flexDirection:"row",alignItems:"center"}}><Text style={{fontSize:px(36)}}>铺货完整度</Text><Text style={{fontSize:px(26)}}>（主图、详情、属性的完整度）</Text></View>
					...
					<View style={{paddingTop: px(24),}}><Text style={{fontSize:px(36)}}>铺货成功率</Text></View>
					...
					<View style={{paddingTop: px(24),}}><Text style={{fontSize:px(36)}}>服务态度</Text></View>
					...
					<View style={{paddingTop: px(24),}}><Text style={{fontSize:px(36)}}>欢迎吐槽</Text></View>
					<Text style={{fontSize:px(26),color:"#a3a6af"}}>{this.state.input_val}</Text>
